...
const validate = (req, res, next) => {
    const schema = joi_1.default.object({
        visitDate: joi_1.default.date().required().label("Visit Date"),
        surveyId: joi_1.default.number().required().label("Survey Id"),
        surveyorId: joi_1.default.number().required().label("Surveyor"),
        storeId: joi_1.default.number().required().label("Store"),
    });
