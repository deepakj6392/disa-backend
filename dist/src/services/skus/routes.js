...
exports.default = [
    ...
    },
    {
        ...
        handler: [
            (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
                const result = yield (0, controller_1.findAllSKUs)(req, next);
                res.status(200).send(result);
            }),
        ],
    },
    {
        ...
        handler: [
            ...
            (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
                const result = yield (0, controller_1.updateSKUById)(req, next);
                res.status(200).send(result);
            }),
        ],
    },
    {
        ...
        handler: [
            checks_1.checkAuthenticate,
            (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
                const result = yield (0, controller_1.getSKUById)(req, next);
                res.status(200).send(result);
            }),
        ],
    },
    {
        ...
        handler: [
            (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
                const result = yield (0, controller_1.deleteSKUById)(req, next);
                res.status(200).send(result);
            }),
        ],
    },
